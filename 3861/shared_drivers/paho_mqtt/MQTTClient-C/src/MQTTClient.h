 ...
 *  @param qos - the maximum quality of service to receive messages at for this topic
 *  @param messageHandler - callback function to be invoked when a message is received on the topic
 *  @return success code
 */
